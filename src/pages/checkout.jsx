	...
	return (
		<>
			...
			{data ? (
				...
				<div className="w-fit mx-auto flex justify-center flex-col h-[50vh] py-20">
					<span className="text-red-400 text-2xl font-semibold">
						You need to be signed in to access this pages
					</span>
					<br />
					<button
						onClick={() => signIn()}
						className="bg-black text-white w-fit mx-auto mt-8 px-4 py-1 text-center transition ease-in-out duration-700  relative  ">
						LOGIN
					</button>
				</div>
			)}
